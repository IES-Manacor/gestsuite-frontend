<template>
  <q-page class="flex column" padding>
    <p class="text-h3">Llistat d'alumnat amb pendents desglossat per grup</p>
...
export default defineComponent({
  ...
  methods: {
    get: async function () {
      ...
      this.grupsClasse.sort((a,b)=>a.gestibNom.localeCompare(b.gestibNom))
      dialog.hide();
    },
    llistat: async function(){
      ...
      await this.$axios.post(process.env.API + '/api/core/google/sheets/alumnatpergruppendents',this.grupsClasseModel);
      dialog.hide();
    }
  }
})
