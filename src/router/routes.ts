...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      { path: 'apps/grupscooperatius/mescla/:id', component: () => import('pages/apps/grups-cooperatius/GrupCooperatiuForm.vue') },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'apps/convalidacions/public/solicitud', component: () => import('pages/apps/convalidacions/SolicitudPublicForm.vue') }
    ]
  },
